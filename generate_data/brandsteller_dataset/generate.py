...
if __name__ == "__main__":
    ...
    parser.add_argument('--train_samples', type=int, default=2**0,
                        help='Samples in the training dataset')
    parser.add_argument('--valid_samples', type=int, default=2 ** 7,
                        help='Samples in the validation dataset')
    parser.add_argument('--test_samples', type=int, default=2 ** 7,
